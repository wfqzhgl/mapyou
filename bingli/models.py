...
class BHistory(models.Model):
    ...
    self_desc = models.TextField("主诉", max_length=1024, blank=True, null=True)
    now_desc = models.TextField("现病史", max_length=1024, blank=True, null=True)
    his_desc = models.TextField("既往史", max_length=1024, blank=True, null=True)
    fam_desc = models.TextField("家族史", max_length=1024, blank=True, null=True)
    zhy_desc = models.TextField("中医诊断", max_length=1024, blank=True, null=True)
    xy_desc = models.TextField("西医诊断", max_length=1024, blank=True, null=True)
    xy_img = models.FileField("西医检资料", upload_to='.', help_text='', blank=True, null=True)
    diagnosis = models.TextField("结论", max_length=1024, blank=True, null=True)
    prescription = models.TextField("处方用药", max_length=1024, blank=True, null=True)
    other_desc = models.TextField("备注", max_length=1024, blank=True, null=True)
    created = models.DateTimeField("创建时间", auto_now_add=True)
#     cell = models.CharField("手机", max_length=50)
    def __unicode__(self):
